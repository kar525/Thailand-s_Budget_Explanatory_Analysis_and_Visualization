...
![image](https://github.com/user-attachments/assets/3a475b22-754b-4f25-a775-58dfee1a4359)


	 
ทั้งสามปีงบประมาณ แผนงานบุคลากรภาครัฐได้รับการจัดสรรงบประมาณสูงที่สุด โดยมีจำนวนงบประมาณตั้งแต่ 7.7 แสนล้านถึง 8 แสนล้านบาท ในช่วงเวลาเดียวกัน แผนงานที่ได้รับการจัดสรรงบประมาณมากที่สุด 9 อันดับแรกยังคงเหมือนกัน แต่มีการเปลี่ยนแปลงในแง่ลำดับ 

![image](https://github.com/user-attachments/assets/4c6851f1-9e87-4ef8-a3cf-fbf56dfde8e9)
