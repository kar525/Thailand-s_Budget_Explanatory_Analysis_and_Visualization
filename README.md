...
จาก correlation matrix จะเห็นได้ว่า งบประมาณมีCorrelationกับปีและรายได้ของรัฐบาลในทิศทางบวกค่อนข้างสูง และมีCorrelationกับค่าดุลงบประมาณในทางลบค่อนข้างสูง โดยจะเลือกตัวแปรดังที่กล่าวที่มี Strong Correlation มาทำโมเดลพยากรณ์จัดสรรงบประมาณด้วย Decision Tree
